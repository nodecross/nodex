...
impl BIP39 {
    pub fn generate_mnemonic(strength: &MnemonicType) -> Result<String, NodeXError> {
...
pub mod tests {
    ...
    fn test_mnemonic_to_seed() {
        ...
        assert_eq!(
            result,
            vec![
                0x94, 0x27, 0x00, 0xe6, 0xd9, 0x46, 0x84, 0xc3, 0xab, 0xe4, 0x87, 0x7a, 0x96, 0x84,
                0x6b, 0xa4, 0x96, 0xfc, 0x00, 0x95, 0xc4, 0x4e, 0xb7, 0x56, 0x0d, 0xae, 0xf7, 0x7c,
                0xdc, 0x4f, 0xb9, 0x26, 0xf1, 0x2f, 0x63, 0x22, 0x3a, 0xac, 0xd0, 0x4c, 0x40, 0x74,
                0x72, 0x2c, 0xee, 0x9a, 0x43, 0x32, 0x66, 0xab, 0x31, 0x51, 0x15, 0x27, 0x4f, 0xa5,
                0x3e, 0x8b, 0x42, 0x07, 0xc7, 0x42, 0xfa, 0xf7,
            ]
        )
    }
    ...
    fn test_mnemonic_to_seed_with_passphrase() {
        ...
        assert_eq!(
            result,
            vec![
                0x11, 0x7e, 0xa2, 0x8c, 0xfb, 0xd1, 0x1f, 0xfa, 0x29, 0x44, 0xe5, 0x09, 0x7b, 0x1b,
                0xeb, 0xb4, 0xfe, 0x14, 0x0e, 0xe7, 0x82, 0xa9, 0x31, 0x08, 0x56, 0x46, 0x51, 0xfc,
                0x36, 0x41, 0x58, 0xee, 0x91, 0x6e, 0x5f, 0x7b, 0x4c, 0x03, 0x9c, 0x4d, 0xcc, 0xe5,
                0x54, 0x6b, 0xa3, 0xbf, 0xe8, 0xce, 0x2f, 0x78, 0xe7, 0xfe, 0x93, 0x0c, 0x8b, 0x25,
                0x9e, 0x38, 0x52, 0xc4, 0x88, 0x03, 0x9b, 0x02,
            ]
        )
    }
}
