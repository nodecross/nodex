...
pub mod tests {
    ...
    fn key() -> Vec<u8> {
        vec![
            0xcd, 0x33, 0x90, 0x46, 0x12, 0x34, 0x25, 0x3d, 0x96, 0x6f, 0xf7, 0x89, 0x8b, 0xc1,
            0x73, 0xfa, 0x1a, 0xa6, 0xbb, 0xc2, 0x3d, 0xdd, 0x90, 0x37, 0x93, 0x03, 0x1c, 0x4d,
            0x65, 0x54, 0x74, 0x0c,
        ]
    }
    ...
    fn nonce() -> Vec<u8> {
        vec![
            0x79, 0x6d, 0xc7, 0x33, 0x43, 0x54, 0xeb, 0x3b, 0x22, 0x32, 0xde, 0x60,
        ]
    }
    ...
    fn cipher_text() -> Vec<u8> {
        vec![
            0xd3, 0x58, 0x02, 0x26, 0xd1, 0xf7, 0x01, 0xe4, 0xe3, 0x42, 0x5e, 0x2e, 0x5d, 0x1f,
            0x5a, 0x67, 0xae, 0x92, 0xfd, 0x2a, 0x23, 0xf1, 0x2d, 0xef, 0xbe, 0x2e, 0x26, 0x59,
            0xc0, 0xb9, 0xd2, 0x54,
        ]
    }
