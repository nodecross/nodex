...
```shell
$ bin/omnibus clean nodex-agent
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/nodex-agent`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean nodex-agent --purge
```
...
[vagrant@ubuntu...] $ cd nodex-agent   # or 'cd nodex-agent/omnibus' if your omnibus project is embedded in your main project
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ bin/omnibus build nodex-agent
```
